                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group  floating-label-form-group">
                            ...
                            <input class="form-control" id="waktu_mulai" type="text" name="waktu_mulai" placeholder="Masukkan Waktu Mulai Kegiatan (Contoh 08:00 atau 13:00)"  autocomplete="off" required="">
                            <script>
                        ...
                        <div class="form-group  floating-label-form-group">
                            ...
                            <input class="form-control" id="waktu_selesai" type="text" name="waktu_selesai" placeholder="Masukkan Waktu Selesai Kegiatan (Contoh 08:00 atau 13:00)" autocomplete="off" required="">
                            <script>
                            $(document).ready(function(){
